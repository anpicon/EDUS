...
//		// section 3.2
//		vec2d A(6, Bvector.size());
//		vec2d S(6, Bvector.size());
//		vec1d q(6);
...
//		}
//
//		q[0] = 1;      q[1] = 1;      q[2] = !(plane_direction+1);
//		for(int row=3; row<6; row++)
//			q[row] = 0;		
//		//svd( U, s, V, A );
// 		LAPACKE_dggsvd3(LAPACK_ROW_MAJOR,'N','N',)		
...
//        		printf(  "\n*         |  %3i  |   % 8.5f    % 8.5f    % 8.5f   | % 8.5f | %8.5f | %8.5e |    %3s     |         *", Shell, 
//        			Bvector[Shell][ib][0],Bvector[Shell][ib][1], Bvector[Shell][ib][2], 
//        			pow(Bvector[Shell][ib][0],2)+pow(Bvector[Shell][ib][1],2)+pow(Bvector[Shell][ib][2],2),w(Shell), norm(q1-q),  (LinearDependent?"YES":"NO"));
//
//        //4. Check if:
...
//                else
//			ShellCounter++;
//		ShellsAreEnough = ( norm(q1-q)<1.e-11 );
